...
const imageChallengesData: ImageChallenge[] = [
  ...
  },
  {
    ...
    description:
      "Master techniques for generating consistent character designs with specific features, clothing, and poses.",
    difficulty: "beginner",
    completionRate: 0.75,
    isCompleted: false,
    imageUrl: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e",
    instructions:
      "Write a prompt to generate a detailed character portrait of a cyberpunk detective with specific clothing, accessories, and lighting.",
    targetDescription:
      "A close-up portrait of a weathered cyberpunk detective with cybernetic eye enhancements, wearing a worn leather trench coat, standing in neon-lit rain at night.",
    tips: [
  ...
  },
  {
    ...
    description:
      "Learn how to craft prompts that generate images in specific artistic styles, from Renaissance to modern art movements.",
    difficulty: "intermediate",
    completionRate: 0.64,
    isCompleted: false,
    imageUrl: "https://images.unsplash.com/photo-1501854140801-50d01698950b",
    instructions:
      "Create a prompt that would generate a still life composition of fruits and flowers in the style of Dutch Golden Age painting.",
    targetDescription:
      "A detailed still life painting in the style of Dutch Golden Age masters featuring a copper bowl of ripe fruits, wilting flowers, and a half-peeled lemon on a dark wooden table with dramatic chiaroscuro lighting.",
    tips: [
  ...
  },
  {
    ...
    description:
      "Transform abstract concepts and ideas into visual representations through carefully crafted prompts.",
    difficulty: "intermediate",
    completionRate: 0.59,
    isCompleted: false,
    imageUrl: "https://images.unsplash.com/photo-1523712999610-f77fbcfc3843",
    instructions:
      "Write a prompt to visualize the abstract concept of 'time' in a surrealistic style.",
    targetDescription:
      "A surrealistic interpretation of time showing melting clocks draped over barren tree branches in a desert landscape, inspired by Salvador Dalí but with a modern digital art approach.",
    tips: [
  ...
  },
  {
    ...
    description:
      "Master advanced techniques for generating complex scenes with multiple interacting objects with precise positioning.",
    difficulty: "advanced",
    completionRate: 0.45,
    isCompleted: false,
    imageUrl: "https://images.unsplash.com/photo-1615729947596-a598e5de0ab3",
    instructions:
      "Create a prompt for a complex scene with multiple objects: a futuristic laboratory with scientists, equipment, and experiments in progress.",
    targetDescription:
      "A detailed wide-angle view of a futuristic laboratory with three scientists in protective suits working at different stations, holographic displays floating in the foreground, complex equipment with glowing elements in the middle ground, and specimen containment units along the walls in the background.",
    tips: [
  ...
  },
  {
    ...
    description:
      "Create detailed technical illustrations, diagrams, and cross-sections through specialized prompting techniques.",
    difficulty: "advanced",
    completionRate: 0.39,
    isCompleted: false,
    imageUrl: "https://images.unsplash.com/photo-1487958449943-2429e8be8625",
    instructions:
      "Write a prompt to generate a detailed technical cross-section illustration of a modern electric vehicle showing its key components.",
    targetDescription:
      "A clean, precise technical cross-section illustration of an electric vehicle showing the battery pack, electric motors, power electronics, cooling system, and passenger compartment with labeled components, in an isometric view with a blueprint aesthetic.",
    tips: [
        ...
        <div className="container max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center mb-4">
              <span
                className={`px-2 py-1 text-xs font-medium rounded-md mr-3 ${
